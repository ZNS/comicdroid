 ...
 */
public class AndroidSlidingDrawer extends ViewGroup {
     ...
     */
    public AndroidSlidingDrawer(Context context, AttributeSet attrs) {
     ...
     */
    public AndroidSlidingDrawer(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.AndroidSlidingDrawer, defStyle, 0);

        int orientation = a.getInt(R.styleable.AndroidSlidingDrawer_orientation, ORIENTATION_VERTICAL);
        mVertical = orientation == ORIENTATION_VERTICAL;
        mBottomOffset = (int) a.getDimension(R.styleable.AndroidSlidingDrawer_bottomOffset, 0.0f);
        mTopOffset = (int) a.getDimension(R.styleable.AndroidSlidingDrawer_topOffset, 0.0f);
        mAllowSingleTap = a.getBoolean(R.styleable.AndroidSlidingDrawer_allowSingleTap, true);
        mAnimateOnClick = a.getBoolean(R.styleable.AndroidSlidingDrawer_animateOnClick, true);

        int handleId = a.getResourceId(R.styleable.AndroidSlidingDrawer_handle, 0);
        if (handleId == 0) {
            throw new IllegalArgumentException("The handle attribute is required and must refer "
                    + "to a valid child.");
        }

        int contentId = a.getResourceId(R.styleable.AndroidSlidingDrawer_content, 0);
        if (contentId == 0) {
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(AndroidSlidingDrawer.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(AndroidSlidingDrawer.class.getName());
    }*/
