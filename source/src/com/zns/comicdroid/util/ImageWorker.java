...
public class ImageWorker {
        ...
        if (cancelPotentialDownload(path, imageView)) {
            switch (mode) {
                ...
                case CORRECT:
                    ...
                    PlaceholderDrawable downloadedDrawable = new PlaceholderDrawable(task);
    ...
    private static BitmapLoaderTask getBitmapLoaderTask(ImageView imageView) {
        if (imageView != null) {
            ...
            if (drawable instanceof PlaceholderDrawable) {
                PlaceholderDrawable downloadedDrawable = (PlaceholderDrawable)drawable;
     ...
     */
    static class PlaceholderDrawable extends ColorDrawable {
        private final WeakReference<BitmapLoaderTask> bitmapDownloaderTaskReference;

        public PlaceholderDrawable(BitmapLoaderTask bitmapDownloaderTask) {
            super(Color.BLACK);
